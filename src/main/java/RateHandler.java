...
public class RateHandler {
    ...
    public static String getClaimRate(Request request, Response response) {
        ...
        claimRate = claimRate + 0.00000006 / ClaimHandler.sumoRate * bitKeer + ";";
        claimRate = claimRate + 0.00000015 / ClaimHandler.sumoRate * bitKeer + ";";
        claimRate = claimRate + 0.00000280 / ClaimHandler.sumoRate * bitKeer + ";";
        claimRate = claimRate + 0.00000638 / ClaimHandler.sumoRate * bitKeer;
